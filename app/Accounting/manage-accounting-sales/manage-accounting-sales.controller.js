(function() {
  ...
  angular
    .module("accounting")
    .controller("ManageAccountingSalesController", ManageAccountingSalesController);

  /* @ngInject */
  function ManageAccountingSalesController($window,UserService, $mdToast, triLoaderService,$filter,$http, $state,$mdDialog) {
    var vm = this;
