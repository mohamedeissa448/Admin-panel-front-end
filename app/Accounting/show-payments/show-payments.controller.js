(function() {
    ...
    angular
        .module('accounting')
        .controller('ShowPaymentsForPurchasingController', ShowPaymentsForPurchasingController);

    /* @ngInject */
    function ShowPaymentsForPurchasingController($mdToast,$mdDialog,UserService, triLoaderService,$http,itemToPay) {
        var vm = this;
