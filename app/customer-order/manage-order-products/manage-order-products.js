(function() {
  ...
  angular
    ...
    .controller("ManageOrderProductsController", ManageCustomerOrderController);
  ...
  function ManageCustomerOrderController(UserService, $mdToast, triLoaderService,$filter,$http,$mdDialog) {
    ...
    function OpenOrderProducts(itemToEdit) {
      $mdDialog.show({
        controller: "FixCustomerOrderProductsController",
        controllerAs: "vm",
        templateUrl:
          "app/customer-order/fix-customer-order-product/fix-customer-order-product.tmpl.html",
        clickOutsideToClose: true,
        focusOnOpen: false,
        //targetEvent: $event,
        onRemoving: function(event, removePromise) {
