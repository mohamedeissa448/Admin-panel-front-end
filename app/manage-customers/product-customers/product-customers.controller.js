(function() {
  ...
  angular
    ...
    .controller("CustomersProductController", CustomersProductController);

  /* @ngInject */
  function CustomersProductController(
    $mdToast,
    triLoaderService,
    $http,
    $mdDialog,
    ...
    $http({
      method: "post",
      url: "http://35.246.143.96:3111/getProductDataByCustomerID",
    ...
    vm.DeleteProduct = function(product) {
      ...
      $http({
        method: "POST",
        url: "http://35.246.143.96:3111/removeProductCustomerCodes",
        data: data
      }).then(function(data) {
        vm.isLoading = false;
      });
    ...
    vm.SaveProduct = function() {
      ...
      $http({
        method: "POST",
        url: "http://35.246.143.96:3111/editProductCustomerCodes",
        data: data
      }).then(function(data) {
        vm.isLoading = false;
      });
