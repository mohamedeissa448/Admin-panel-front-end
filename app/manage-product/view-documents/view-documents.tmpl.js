...
(function () {
    ...
    angular 
        .module('stores')
        .controller('ViewProductDocumentsController', ViewProductDocumentsController);

    /* @ngInject */
    function ViewProductDocumentsController($mdToast, $mdDialog,$scope, triLoaderService,UserService, $http, itemToViewItsDocuments) {
      var vm = this;
