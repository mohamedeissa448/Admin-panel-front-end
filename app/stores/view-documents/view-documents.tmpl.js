...
(function () {
    ...
    angular
        ...
        .controller('ViewStoreProductDocumentsController', ViewStoreProductDocumentsController);

    /* @ngInject */
    function ViewStoreProductDocumentsController($mdToast, $mdDialog,$scope, triLoaderService,UserService, $http, itemToViewItsDocuments) {
      var vm = this;
